...
deb https://{%endraw%}mirror.nju.edu.cn{%raw%}/mysql/apt/{{os_name}} {{release_name}} mysql-5.6 mysql-5.7 mysql-8.0 mysql-tools
</script>
{%endraw%}
...
baseurl=https://{%endraw%}mirror.nju.edu.cn{%raw%}/mysql/yum/mysql-connectors-community-{{release_name}}-$basearch/
enabled=1
gpgcheck=1
...
baseurl=https://{%endraw%}mirror.nju.edu.cn{%raw%}/mysql/yum/mysql-tools-community-{{release_name}}-$basearch/
enabled=1
gpgcheck=1
gpgkey=https://repo.mysql.com/RPM-GPG-KEY-mysql
...
baseurl=https://{%endraw%}mirror.nju.edu.cn{%raw%}/mysql/yum/mysql-5.6-community-{{release_name}}-$basearch/
enabled=0
gpgcheck=1
gpgkey=https://repo.mysql.com/RPM-GPG-KEY-mysql
...
baseurl=https://{%endraw%}mirror.nju.edu.cn{%raw%}/mysql/yum/mysql-5.7-community-{{release_name}}-$basearch/
enabled=1
gpgcheck=1
gpgkey=https://repo.mysql.com/RPM-GPG-KEY-mysql
{{/if}}
...
baseurl=https://{%endraw%}mirror.nju.edu.cn{%raw%}/mysql/yum/mysql-8.0-community-{{release_name}}-$basearch/
enabled=1
gpgcheck=1
gpgkey=https://repo.mysql.com/RPM-GPG-KEY-mysql
</script>
