...
deb http://{%endraw%}mirror.nju.edu.cn{%raw%}/raspbian/raspbian/ {{release_name}} main non-free contrib rpi
deb-src http://{%endraw%}mirror.nju.edu.cn{%raw%}/raspbian/raspbian/ {{release_name}} main non-free contrib rpi

# 编辑 `/etc/apt/sources.list.d/raspi.list` 文件，删除原文件所有内容，用以下内容取代：
deb http://{%endraw%}mirror.nju.edu.cn{%raw%}/raspberrypi/ {{release_name}} main ui
</script>
{% endraw %}
